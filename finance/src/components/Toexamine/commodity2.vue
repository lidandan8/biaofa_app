<template>
  <div>
    ...
    <div class="tab-contents">
      <div v-show="cur==0">
        <ul class="lists">
          <li class="list" v-for="(item,index)  in data" :key="index""><div style="width: 33.3%;float: left;text-align: center;" @click="purchase2">
      ...
      <div v-show="cur==1">
        <ul class="lists">
          <li class="list" v-for="(item,index)  in data" :key="index""><div style="width: 33.3%;float: left;text-align: center;" @click="again1">
            <div  v-for="i in item.name" :key="i">{{i}}</div>
          </div>
            <div style="width: 33.3%;float: left;text-align: center;position: relative;">
              <div style="text-align: center;position: absolute;top: 50%;left: 25%;-webkit-transform: translateY(-50%);-ms-transform: translateY(-50%);-o-transform: translateY(-50%);transform: translateY(-50%);">
