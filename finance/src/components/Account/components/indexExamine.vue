<template>
  <div>
    ...
    <ul class="Central_section am-margin-top">
      <li class="Central_section1" @click="getMethod"><img src="../../../assets/images/account/shenhe.png" alt=""></li>
      <li class="Central_section1" @click="getMetho"><img src="../../../assets/images/account/sell.png" alt=""></li>
      <li class="Central_section1" @click="getMethod2"><img src="../../../assets/images/account/tuihuo.png" alt=""></li>
    </ul>
...
export default {
  ...
  methods: {
    ...
    getMetho: function () {
      this.$router.push('/commodity1')
    },
    getMethod2: function () {
      this.$router.push('/commodity2')
    }
  }
}
</script>
...
<style scoped lang="scss">
  .accountCont {
    background: url("../../../assets/images/account/accountIn.png") no-repeat top center;
