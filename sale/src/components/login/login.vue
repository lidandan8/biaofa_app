...
<style scoped>
 .login{ padding: 0 1.6rem;}
 .login .logo{ text-align: center; padding-top: 4em;}
 .login .logo p{ color: #24278E; font-size: 2rem; line-height: 3.4rem; font-weight: bold}


 .login li{  display: flex; align-items: center; justify-content: center;}
 .login ul p{ font-size: 1.2rem;}

 .login ul{ padding-top: 2em;}
 .login li{ height: 3.4rem; background: #F2F2F2;  border-radius: 1.7rem; color: #999999; font-size: 1.4rem; margin-bottom: 1.6rem; position: relative;}
 .login li .text{ flex: 1;}

 .login li .text input{ border: none; background: none; outline: none; color: #333;}
 .login li span{ float: left; width: 4.4rem; display: inline-block; margin: 0 1.2rem; font-size: 1.4rem;}

 .login li .getCode{ display: flex; align-items: center; justify-content: center;
   font-size: 1.2rem; height: 2.4rem; line-height: 2.4rem; color: #fff; background-color: #33CBCC; position: absolute;
   top:0.5rem; padding: 0 1rem; right: 1rem; z-index: 10;  border-radius: 2rem;}
 .login li .getCode.unable{ background-color: #ccc; }

 .class_buttom{ width: 100%; border: none; border-radius: 1.7rem; outline: none; margin: 2rem 0 1rem; height: 3.4rem; background: #33CBCC; color: #ffffff; font-size: 1.6rem;}
</style>
