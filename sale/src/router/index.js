...
export default new Router({
  routes: [
    ...
    {
      path: '/returnGoods', // 销售退货 @author liDanDan 2019-10-14
      name: 'returnGoods',
      component: () => import('../components/Account/returnGoods')
    },
    {
      path: '/SalesRecords', // 销售退货 @author liDanDan 2019-10-14
      name: 'SalesRecords',
      component: () => import('@/components/Account/SalesRecords')
    },
    {
      path: '/SalesSlip', // 销售单 @author liDanDan 2019-10-14
      name: 'SalesSlip',
      component: () => import('../components/Account/SalesSlip')
    },
    {
      path: '/salesReceivables', // 销售单 @author liDanDan 2019-10-14
      name: 'salesReceivables',
      component: () => import('../components/Account/salesReceivables')
    },
    {
      path: '/receivables', // 收款 @author liDanDan 2019-10-15
      name: 'receivables',
      component: () => import('../components/Account/receivables')
    },
    {
      path: '/MyRecord', // 我的销售记录 @author liDanDan 2019-10-15
      name: 'MyRecord',
      component: () => import('../components/Account/MyRecord')
    },
    {
      path: '/product', // 产品管理 @author liDanDan 2019-10-15
      name: 'product',
      component: () => import('../components/Account/product')
    },
    {
      path: '/newProduct', // 产品查询 @author liDanDan 2019-10-15
      name: 'newProduct',
      component: () => import('../components/Account/newProduct')
    },
    {
      path: '/ProductSearch', // 产品管理搜索 @author liDanDan 2019-10-15
      name: 'ProductSearch',
      component: () => import('../components/Account/ProductSearch')
    },
    {
      path: '/test', // 产品管理搜索 @author liDanDan 2019-10-15
      name: 'test',
      component: () => import('../components/test/index')
    },
    {
      path: '/addSales', // 销售单新增 @author liDanDan 2019-10-16
      name: 'addSales',
      component: () => import('../components/Account/addSales')
    },
    {
